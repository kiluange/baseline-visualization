export const MenuBar = Vue.component('menu-bar', {
  ...
  <div class="dropdown-menu dropdown-menu-right">
      <router-link class="dropdown-item" to="/dashboard/domciliar">Domiciliar</router-link>
      <router-link class="dropdown-item" to="/dashboard/familiar">Familiar</router-link>
      <router-link class="dropdown-item" to="/dashboard/individual">Individual</router-link>
    </div>
  </li>
</ul>
    </nav>`,
